...
binaryImage = thresholding.Lasso_fnc(Cropped_img_int);

%% Step 1-2: Refining background brightness
Refined_surf_img = thresholding.Background_fnc(binaryImage,Cropped_img_int);
...
hst = uicontrol('Style', 'slider',...
    ...
    'Callback', {@thresholding.Thresh_Slider});
get(hst,'value')
